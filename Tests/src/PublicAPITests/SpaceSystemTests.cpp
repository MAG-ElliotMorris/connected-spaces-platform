 ...
 */
class EnterSpaceWhenInvited : public PublicTestBaseWithParam<std::tuple<SpaceAttributes, csp::systems::EResultCode>>
{
};

class EnterSpaceWhenUninvited : public PublicTestBaseWithParam<std::tuple<SpaceAttributes, csp::systems::EResultCode>>
{
};

class EnterSpaceWhenCreator : public PublicTestBaseWithParam<std::tuple<SpaceAttributes, csp::systems::EResultCode>>
{
};
...
INSTANTIATE_TEST_SUITE_P(SpaceSystemTests, EnterSpaceWhenUninvited,
    testing::Values(std::make_tuple(SpaceAttributes::Gated, csp::systems::EResultCode::Failed),
        std::make_tuple(SpaceAttributes::IsDiscoverable, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::None, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::Private, csp::systems::EResultCode::Failed),
        std::make_tuple(SpaceAttributes::Public, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::RequiresInvite, csp::systems::EResultCode::Failed),
        std::make_tuple(SpaceAttributes::Unlisted, csp::systems::EResultCode::Success)));

INSTANTIATE_TEST_SUITE_P(SpaceSystemTests, EnterSpaceWhenInvited,
    testing::Values(std::make_tuple(SpaceAttributes::Gated, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::IsDiscoverable, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::None, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::Private, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::Public, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::RequiresInvite, csp::systems::EResultCode::Success),
        std::make_tuple(SpaceAttributes::Unlisted, csp::systems::EResultCode::Success)));
